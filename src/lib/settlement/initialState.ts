...
export function createInitialSettlement(seed: number, now = Date.now()): SettlementSimulationState {
  ...
  wreckage.outputInventory = { gold: 520, logs: 24, stone: 6, 'iron-ingots': 8, fiber: 18, water: 20, hardtack: 64, tools: 6, rope: 12, cloth: 8, medicine: 3, rum: 12, cannonballs: 38, powder: 16 };
